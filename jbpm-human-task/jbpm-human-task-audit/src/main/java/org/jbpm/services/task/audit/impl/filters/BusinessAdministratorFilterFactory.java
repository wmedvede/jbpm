 ...
 * @author salaboy
 */
public class BusinessAdministratorFilterFactory {
    ...
    public FilterKey getKey() {
        ...
        key.addParameter(businessAdministrator);
        return key;
    }
    ...
    public Filter getFilter() {
        ...
        Query query = new TermQuery(new Term("businessAdministrators", businessAdministrator));
